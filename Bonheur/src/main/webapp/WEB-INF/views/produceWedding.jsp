...
<div id="step1">
    ...
    <div id="weddinghallInfo">
    	<div class="innerContents">
    		<p id="title" class="kor Bold">예식장 정보</p>
    		<hr>
    		  <div class="row">
    			<div class="col-md-2" style="line-height: 3; padding-right:0">
		    		<p id="sub-title" class="kor Bold">예식 일시</p>
		    		<p id="sub-title" class="kor Bold">예식장명</p>
		    		<p id="sub-title" class="kor Bold">층/홀/실</p>
		    		<p id="sub-title" class="kor Bold">예식장 연락처</p>
		    		<p id="sub-title" class="kor Bold">예식장 주소</p>
		    		<div style="display: flex; align-items: center; height: 400px;">
			    		<p id="sub-title" class="kor Bold">예식장 약도</p>
		    		</div>
    			</div>
    			<div class="col-md-10" style="line-height: 3; padding-left: 24">
    				...
    				<div style="display: flex; align-items: center; height: 60px"><input onblur="updateInvitationTitle()" name="weddingHallName" class="input-box input-box-lg"></div>
    				<div style="display: flex; align-items: center; height: 60px"><input onblur="updateInvitationTitle()" name="weddingHallDetail" class="input-box input-box-lg"></div>
    				<div style="display: flex; align-items: center; height: 60px"><input onblur="updateInvitationTitle()" name="weddingHallCall" class="input-box input-box-lg"></div>
		    		<!-- 카카오ㄴ -->
					 <div style="display: flex; align-items: center; height: 60px;">
						<input onblur="updateInvitationTitle()" name="weddingHallAddress" type="text" id="keyword" class="search-input input-box input-box-lg" onclick="postCode();" style="margin-right:10px;">
    ...
    <div id="etcInfo">
    	<div class="innerContents">
    	  <div class="row">
			  ...
			  <div onchange="updateInvitationTitle()" class="col-md-4" style="display: flex; align-items: center;">
    		...
    		<div class="row" id="etcContents">
    			<div class="col-md-2" style="line-height: 3">
    				...
    				<div style="display: flex; align-items: center; height: 60px" id="optTitle1" hidden><input onblur="updateInvitationTitle()" name="addOption3" class="input-box input-box-st" placeholder=" 직접입력"></div>
    				<div style="display: flex; align-items: center; height: 60px" id="optTitle2" hidden><input onblur="updateInvitationTitle()" name="addOption4" class="input-box input-box-st" placeholder=" 직접입력"></div>
    				<div style="display: flex; align-items: center; height: 60px" id="optTitle3" hidden><input onblur="updateInvitationTitle()" name="addOption5" class="input-box input-box-st" placeholder=" 직접입력"></div>
    				<div style="display: flex; align-items: center; height: 60px" id="optTitle4" hidden><input onblur="updateInvitationTitle()" name="addOption6" class="input-box input-box-st" placeholder=" 직접입력"></div>
    			</div>
    			<div class="col-md-10">
    				<div style="display: flex; align-items: center; height: 60px"><textarea onblur="updateInvitationTitle()" name="busInfo" class="input-box input-box-lg"></textarea></div>
    				<div style="display: flex; align-items: center; height: 60px"><textarea onblur="updateInvitationTitle()" name="ownCarInfo" class="input-box input-box-lg"></textarea></div>
    				<div style="display: flex; align-items: center; height: 60px" id="optContents1" hidden>
    					<textarea onblur="updateInvitationTitle()" name="option3" class="input-box input-box-lg"></textarea>
    					<button class="btn btn-primary btn-produce-sm kor" id="delBtn1" style="width:75px; margin-left:15px" onclick="etcDelOption(); updateInvitationTitle()">삭제</button>
    				</div>
    				<div style="display: flex; align-items: center; height: 60px" id="optContents2" hidden>
    					<textarea onblur="updateInvitationTitle()" name="option4" class="input-box input-box-lg"></textarea>
    					<button class="btn btn-primary btn-produce-sm kor" id="delBtn2" style="width:75px; margin-left:15px" onclick="etcDelOption(); updateInvitationTitle()">삭제</button>
    				</div>
    				<div style="display: flex; align-items: center; height: 60px" id="optContents3" hidden>
    					<textarea onblur="updateInvitationTitle()" name="option5" class="input-box input-box-lg"></textarea>
    					<button class="btn btn-primary btn-produce-sm kor" id="delBtn3" style="width:75px; margin-left:15px" onclick="etcDelOption(); updateInvitationTitle()">삭제</button>
    				</div>
    				<div style="display: flex; align-items: center; height: 60px" id="optContents4" hidden>
    					<textarea onblur="updateInvitationTitle()" name="option6" class="input-box input-box-lg"></textarea>
    					<button class="btn btn-primary btn-produce-sm kor" id="delBtn4" style="width:75px; margin-left:15px" onclick="etcDelOption(); updateInvitationTitle()">삭제</button>
    				</div>
    	...
    	<div class="innerContents">
    	  <div class="row">
			  ...
			  <div class="col-md-4" style="display: flex; align-items: center;">
				 <div onchange="updateInvitationTitle()" style="display: inline-block; margin: 0px 0px 0px auto;">
					<div class="form-check">
    		...
    		<div id="kakaoPay" style="line-height:3">
    			<div class="kakaoPay-image-box">
					<img id="kakaoPay-img-preview" style="width:15vw">
				</div>
					<input type="file" id="qr-file" onchange="previewImage(event)" style="display:none;">
				      <label class="btn btn-primary btn-produce-sm kor" for="qr-file">
				        <p>파일선택</p>
				      </label>
    			...
    			<div class="col-md-3" style="line-height: 3; padding-right:0">
    				<div style="display: flex; align-items: center; height: 60px">
					    <select name="actSelect1" class="actSelect1 form-select" aria-label="Default select example" style="width: 150px">
					        ...
					        <option value="신랑혼주">신랑혼주</option>
					        <option value="신부혼주">신부혼주</option>
				 ...
				 <div class="row">
				 	...
				 	<div class="col-md-10">
					 	<div style="display: flex; align-items: center; height: 60px" id="">
	    					...
	    					<button class="btn btn-primary btn-produce-sm kor" id="" style="width:100px; margin-left:15px" onclick="updateInvitationTitle()">적용하기</button>
	    				</div>
				 	</div>
				 </div>
				<!-- YouTobe Modal -->
			          ...
			          <div class="d-flex align-items-center p-2">
			            <div class="flex-shrink-0 me-3">
			              <div class="width-8 h-auto rounded-3">
			                <img onload="updateInvitationTitle()" data-dz-thumbnail="data-dz-thumbnail" class="galleryImage w-full h-auto rounded-3 block" src="#" alt="Dropzone-Image" style="width: 120px;"/>
			              </div>
			            </div>
			            ...
			            <div class="shrink-0 ms-3">
			              <button onclick="deleteGalleryImg()" data-dz-remove="data-dz-remove" class="btn btn-sm btn-danger deleteBtn">Delete</button>
			            </div>
			          </div>
			        </div>
			      </li>
...
<div id="step3" hidden>
	...
	<div class="message-box" style="z-index:1" hidden>
		<button type="button" class="btn-close" aria-label="Close" style="margin-left: 85%;" onClick="hiddenMessageBox()"></button>
        <div class="kor Regular" style="font-size: 30px; color: #58AAFF;">청첩장 제작이 완료되었습니다.</div>
        <input type="text" class="URLplaceholder" placeholder=" www.bonheur.team/wedding/1"/>
        <button type="button" class="message-box-btn">Copy</button>
        <div style="margin-top: 30px; margin-bottom: 40px;">
            <img src="resources/images/KAKAOTALK.png" width="55px" style="margin-right: 20px;"/>
            <img src="resources/images/INSTAGRAM.png" width="55px" style="margin-right: 20px;"/>
            <img src="resources/images/LINE.png" width="55px" style="margin-right: 20px;"/>
            <img src="resources/images/FACEBOOK.png" width="55px" style="margin-right: 20px;"/>
       </div>
       <div class="kor Regular" style="font-size: 15px; color: #6C757D; margin-bottom: 20px;">
            보네르는 모든 서비스를 무료로 제공하고 있습니다.<br>
            더 좋은 서비스를 제공하기 위해 저희 보네르 팀을 후원해주세요.
       </div>
       <img src="resources/images/KAKAOPAY.png" width="200px"/>
    </div>
</div><!-- step3 End -->
        ...
        <div class="innerContents button-control" style="display:flex; justify-content: center;">
            ...
            <button type="button" class="btn btn-primary btn-move kor complateBtn" hidden>제작완료</button>
        </div>
...
<script>
const copyBtn = document.querySelector('.message-box-btn');

copyBtn.addEventListener('click', () => {
  const url = document.getElementsByClassName('URLplaceholder')[0].value;
  navigator.clipboard.writeText(url);
});

function hiddenMessageBox(){
	document.getElementsByClassName('message-box')[0].hidden = true;
}
/* 동적으로 값 변경 */
function previewImage(event) {
	var dataURL = null
			...
			reader.onload = function(){
				...
				input.src = dataURL;
				//서버 다녀와서 qr link 가져오기
				let formData = new FormData();
				formData.append("qrCode",dataURL);
				serverCallByFetchAjax(formData, "/getQRLink", "post", "resGetQRLink");
			};
			reader.readAsDataURL(input.files[0]);
		}
		
function resGetQRLink(serverData){
	const iframeDOM = document.querySelector('iframe');
	console.log(serverData.subOptionValue);
	iframeDOM.contentWindow.document.querySelector('.kakao-transfer').setAttribute("onclick","location.href='"+ serverData.subOptionValue +"'")
}
...
function updateInvitationTitle() {
	...
	let honjuUseable = document.getElementsByName('honjuUseable')[0].checked;
    let groomSideType1 = document.getElementsByClassName('groomSideType1')[0].value;
    let groomSideName1 = document.getElementsByName('groomSideName1')[0].value;
    let groomSidePhoneNumber1 = document.getElementsByName('groomSidePhoneNumber1')[0].value;
    let groomSideType2 = document.getElementsByClassName('groomSideType2')[0].value;
    let groomSideName2 = document.getElementsByName('groomSideName2')[0].value;
    let groomSidePhoneNumber2 = document.getElementsByName('groomSidePhoneNumber2')[0].value;
    let brideSideType1 = document.getElementsByClassName('brideSideType1')[0].value;
    let brideSideName1 = document.getElementsByName('brideSideName1')[0].value;
    let brideSidePhoneNumber1 = document.getElementsByName('brideSidePhoneNumber1')[0].value;
    let brideSideType2 = document.getElementsByClassName('brideSideType2')[0].value;
    let brideSideName2 = document.getElementsByName('brideSideName2')[0].value;
    let brideSidePhoneNumber2 = document.getElementsByName('brideSidePhoneNumber2')[0].value;
	let etcUseable = document.getElementsByName('etcUseable')[0].checked;
	let kakaoPayUseable = document.getElementsByName('kakaoPayUseable')[0].checked;
	let accountUseable = document.getElementsByName('accountUseable')[0].checked;
	let videoUseable = document.getElementsByName('videoUseable')[0].checked;
	let imageUseable = document.getElementsByName('imageUseable')[0].checked;
	let groomName = document.getElementsByName('groomName')[0].value;
	let groomPhoneNumber = document.getElementsByName('groomPhoneNumber')[0].value;
	let brideName = document.getElementsByName('brideName')[0].value;
	let bridePhoneNumber = document.getElementsByName('bridePhoneNumber')[0].value;
	let weddingHallName = document.getElementsByName('weddingHallName')[0].value;
	let weddingHallDetail = document.getElementsByName('weddingHallDetail')[0].value;
	let weddingHallCall = document.getElementsByName('weddingHallCall')[0].value;
	let weddingHallAddress = document.getElementsByName('weddingHallAddress')[0].value;
	let busInfo = document.getElementsByName('busInfo')[0].value;
	let ownCarInfo = document.getElementsByName('ownCarInfo')[0].value;
	let videoURL = document.getElementsByName('videoURL')[0].value;
	let addOption3 = document.getElementsByName('addOption3')[0].value;
	let option3 = document.getElementsByName('option3')[0].value;
	let addOption4 = document.getElementsByName('addOption4')[0].value;
	let option4 = document.getElementsByName('option4')[0].value;
	let addOption5 = document.getElementsByName('addOption5')[0].value;
	let option5 = document.getElementsByName('option5')[0].value;
	let addOption6 = document.getElementsByName('addOption6')[0].value;
	let option6 = document.getElementsByName('option6')[0].value;
    ...
    //신랑&신부 이름
    iframeDOM.contentWindow.document.querySelector('.host-name > h1').innerText = groomName + " & " + brideName;
    //제목
    iframeDOM.contentWindow.document.querySelector('.title > h1').innerText = title;
    //인사말
    iframeDOM.contentWindow.document.querySelector('.greetMsg > div').innerText = greetTextarea;
    //방명록
    if(!guestbookUseable){
    ...
    //기타정보 사용여부
    if(!etcUseable){
    	iframeDOM.contentWindow.document.getElementsByClassName('location-subInfo')[0].style.display='none';
    }else{
    	iframeDOM.contentWindow.document.getElementsByClassName('location-subInfo')[0].style.display='';
    }
    //기타정보
    iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(1)').innerText = busInfo;
    iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(2)').innerText = ownCarInfo;
    //기타정보 추가
    if(opt1.hidden){
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(3)').innerText = null;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(3)').innerText = null;
    }else{
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(3)').innerText = addOption3;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(3)').innerText = option3;
    }
    if(opt2.hidden){
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(4)').innerText = null;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(4)').innerText = null;
    }else{
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(4)').innerText = addOption4;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(4)').innerText = option4;
    }
    if(opt3.hidden){
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(5)').innerText = null;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(5)').innerText = null;
    }else{
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(5)').innerText = addOption5;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(5)').innerText = option5;
    }
    if(opt4.hidden){
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(6)').innerText = null;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(6)').innerText = null;
    }else{
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > h6:nth-of-type(6)').innerText = addOption6;
    	iframeDOM.contentWindow.document.querySelector('.location-subInfo > p:nth-of-type(6)').innerText = option6;
    }
    //혼주 사용여부
    if(!honjuUseable){
	    iframeDOM.contentWindow.document.getElementsByTagName('div')[0].children[3].style.display='none';
    }else{
	    iframeDOM.contentWindow.document.getElementsByTagName('div')[0].children[3].style.display='';
    }
    //혼주1 이름, 전화번호
     if(groomSideType1=="입력안함"){
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) > p:nth-of-type(2)').innerText = null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(1)').href = "tel:"+null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(2)').href = "sms:"+null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(1) > i:nth-of-type(1)').style.display = 'none';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(2) > i:nth-of-type(1)').style.display = 'none';
     }else {
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) > p:nth-of-type(2)').innerText = groomSideType1 +" : "+ groomSideName1;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(1)').href = "tel:"+groomSidePhoneNumber1;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(2)').href = "sms:"+groomSidePhoneNumber1;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(1) > i:nth-of-type(1)').style.display = '';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(2) > i:nth-of-type(1)').style.display = '';
     }
    if(brideSideType1=="입력안함"){
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) > p:nth-of-type(2)').innerText = null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(1)').href = "tel:"+null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(2)').href = "sms:"+null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(1) > i:nth-of-type(1)').style.display = 'none';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(2) > i:nth-of-type(1)').style.display = 'none';
     }else{
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) > p:nth-of-type(2)').innerText = brideSideType1 +" : "+ brideSideName1;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(1)').href = "tel:"+brideSidePhoneNumber1;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(2)').href = "sms:"+brideSidePhoneNumber1;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(1) > i:nth-of-type(1)').style.display = '';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(2) > i:nth-of-type(1)').style.display = '';
     }
    //혼주2 이름, 전화번호
    if(groomSideType2=="입력안함"){
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) > p:nth-of-type(3)').innerText = null;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(3)').href = "tel:"+null;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(4)').href = "sms:"+null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(3) > i:nth-of-type(1)').style.display = 'none';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(4) > i:nth-of-type(1)').style.display = 'none';
    }else{
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) > p:nth-of-type(3)').innerText = groomSideType2 +" : "+ groomSideName2;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(3)').href = "tel:"+groomSidePhoneNumber2;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(4)').href = "sms:"+groomSidePhoneNumber2;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(3) > i:nth-of-type(1)').style.display = '';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(1) > div:nth-child(1) >  a:nth-of-type(4) > i:nth-of-type(1)').style.display = '';
    }
    if(brideSideType1=="입력안함"){
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) > p:nth-of-type(3)').innerText = null;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(3)').href = "tel:"+null;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(4)').href = "sms:"+null;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(3) > i:nth-of-type(1)').style.display = 'none';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(4) > i:nth-of-type(1)').style.display = 'none';
    }else{
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) > p:nth-of-type(3)').innerText = brideSideType2 +" : "+ brideSideName2;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(3)').href = "tel:"+brideSidePhoneNumber2;
	     iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(4)').href = "sms:"+brideSidePhoneNumber2;
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(3) > i:nth-of-type(1)').style.display = '';
         iframeDOM.contentWindow.document.querySelector('.contact2 > div:nth-child(2) > div:nth-child(1) >  a:nth-of-type(4) > i:nth-of-type(1)').style.display = '';
    }
    //메인이미지
    let mainImg = document.getElementsByName('mainImage')[1].value;
    if(mainImg != ''){
	     iframeDOM.contentWindow.document.querySelector('.main').style.backgroundImage = "url("+mainImg+")";
    }
    //카카오페이
    if(!kakaoPayUseable){
    	iframeDOM.contentWindow.document.getElementsByClassName('kakao-transfer')[0].style.display='none';
    }else{
    	iframeDOM.contentWindow.document.getElementsByClassName('kakao-transfer')[0].style.display='';
    }
    //계좌 정보
    if(!accountUseable){
    	iframeDOM.contentWindow.document.getElementsByClassName('account-number')[0].style.display='none';
    }else{
    	iframeDOM.contentWindow.document.getElementsByClassName('account-number')[0].style.display='';
    }
    //축의금
    if(!kakaoPayUseable && !accountUseable){
    	iframeDOM.contentWindow.document.getElementsByClassName('money-gift')[0].style.display='none';
    }else{
    	iframeDOM.contentWindow.document.getElementsByClassName('money-gift')[0].style.display='';
    }
    //초대영상
    if(!videoUseable){
    	iframeDOM.contentWindow.document.getElementsByClassName('movie')[0].style.display='none';
    }else{
    	iframeDOM.contentWindow.document.getElementsByClassName('movie')[0].style.display='';
    }
    //이미지관리
    if(!imageUseable){
    	iframeDOM.contentWindow.document.getElementsByClassName('gallery')[0].style.display='none';
    }else{
    	iframeDOM.contentWindow.document.getElementsByClassName('gallery')[0].style.display='';
    }
    //갤러리 이미지
	let imgElements = document.querySelectorAll('.galleryImage');
	let galleryImages = iframeDOM.contentWindow.document.querySelectorAll('.gallery-image');
	let iframeGallery = iframeDOM.contentWindow.document.getElementsByClassName("gallery")[0];
	let child = iframeGallery.lastElementChild;
	while(child !== iframeGallery.firstElementChild){
		iframeGallery.removeChild(child);
		child = iframeGallery.lastElementChild;
	}
	if (imgElements.length != 0) {
	  for (let i = 0; i < imgElements.length; i++) {
		  const imgUrl = imgElements[i].src;
		  let imagesDiv = document.createElement('div');
		  imagesDiv.setAttribute('class','gallery-image');
		  imagesDiv.style.backgroundImage="url("+imgUrl+")";
			iframeGallery.appendChild(imagesDiv);  
	  }
	}
    //video URL
    if(videoURL){
	    iframeDOM.contentWindow.document.querySelector('video > source').setAttribute("src",videoURL);
    }
}
...
/*
	...
	//갤러리 이미지
	for (let i = 0; i < imgElements.length; i++) {
		imgElements[i].addEventListener("load", function() {
			iframeDOM.addEventListener("load", function() {
				const imgUrl = imgElements[i].src;
				galleryImages[i].style.backgroundImage = 'url(' + imgUrl + ')';
			});
		});
	}
	for (let j = imgElements.length; j < galleryImages.length; j++) {
		galleryImages[j].style.display = 'none';
	}
*/
	function deleteGalleryImg() {

		var li = event.target.closest('li');// 클릭한 버튼의 부모 li 개체
		let iframeDOM = document.querySelector('iframe');
		let imgElements = document.querySelectorAll('.galleryImage');

		// iframe 내부의 document에서 해당 개체를 찾아서 삭제
		let galleryImages = iframeDOM.contentWindow.document
				.querySelectorAll('.gallery-image');
		for (let i = 0; i < galleryImages.length; i++) {
			if (galleryImages[i].style.backgroundImage.indexOf(li
					.querySelector('img').src) != -1) {
	...
	function getIframeLink() {
		...
		document.getElementsByTagName('iframe')[0].src = "/template/"
				+ itemInfo.itemList[0].templateCode.toLowerCase();
	}
	...
	function inputNullCheck() {
		...
		let weddingHallDetail = document.getElementsByName('weddingHallDetail')[0].value;
		let weddingHallCall = document.getElementsByName('weddingHallCall')[0].value;
		let weddingHallAddress = document
				.getElementsByName('weddingHallAddress')[0].value;
		...
		if (url !== "" && title !== "" && greetTextarea !== ""
				&& groomName !== "" && groomPhoneNumber !== ""
				&& brideName !== "" && bridePhoneNumber !== ""
				&& weddingHallName !== "" && weddingHallDetail !== ""
				&& weddingHallCall !== "" && weddingHallAddress !== ""
				&& thumbNailImage !== "" && mainImage !== "") {
			result = true;
			console.log('청첩장 유효성검사true');
		}
		console.log(result);
		return result;
	}
	...
	function itemInfoData() {
		...
		let templateCode = document.getElementsByTagName('iframe')[0].src
				.slice(-8).toUpperCase();
		let itemStatus = '0';
		let thumbNailImage = document.getElementsByName('thumbNailImage')[1].value;
		let mainImage = document.getElementsByName('mainImage')[1].value;
		...
		serverCallByFetchAjax(formData, "/Api/InsertItemStep1", "post",
				"resItemInfoData");
	}
	...
	function optionSubData() {
		...
		let guestbookCheckedId = guestbookUseable.checked ? guestbookUseable.id
				: null;

		//신랑신부
		let groomName = document.getElementsByName('groomName')[0];
		let groomCheckInput = document.getElementsByName('groomCheckInput')[0];
		let groomPhoneNumber = document.getElementsByName('groomPhoneNumber')[0];
		let groomCheckBox = document.getElementsByName('groomCheckBox')[0];

		let brideName = document.getElementsByName('brideName')[0];
		let brideCheckInput = document.getElementsByName('brideCheckInput')[0];
		let bridePhoneNumber = document.getElementsByName('bridePhoneNumber')[0];
		let brideCheckBox = document.getElementsByName('brideCheckBox')[0];

		//혼주
		let honjuUseable = document.getElementsByName('honjuUseable')[0];
		let honjuCheckedId = honjuUseable.checked ? honjuUseable.id : null;

		let groomSideType1 = document.getElementsByClassName('groomSideType1')[0];
		let groomSideName1 = document.getElementsByName('groomSideName1')[0];
		let groomSideCheckInput1 = document
				.getElementsByName('groomSideCheckInput1')[0];
		let groomSidePhoneNumber1 = document
				.getElementsByName('groomSidePhoneNumber1')[0];
		let groomSideCheckBox1 = document.getElementById('groomSideCheckBox1');

		let groomSideType2 = document.getElementsByClassName('groomSideType2')[0];
		let groomSideName2 = document.getElementsByName('groomSideName2')[0];
		let groomSideCheckInput2 = document
				.getElementsByName('groomSideCheckInput2')[0];
		let groomSidePhoneNumber2 = document
				.getElementsByName('groomSidePhoneNumber2')[0];
		let groomSideCheckBox2 = document.getElementById('groomSideCheckBox2');

		let brideSideType1 = document.getElementsByClassName('brideSideType1')[0];
		let brideSideName1 = document.getElementsByName('brideSideName1')[0];
		let brideSideCheckInput1 = document
				.getElementsByName('brideSideCheckInput1')[0];
		let brideSidePhoneNumber1 = document
				.getElementsByName('brideSidePhoneNumber1')[0];
		let brideSideCheckBox1 = document.getElementById('brideSideCheckBox1');

		let brideSideType2 = document.getElementsByClassName('brideSideType2')[0];
		let brideSideName2 = document.getElementsByName('brideSideName2')[0];
		let brideSideCheckInput2 = document
				.getElementsByName('brideSideCheckInput2')[0];
		let brideSidePhoneNumber2 = document
				.getElementsByName('brideSidePhoneNumber2')[0];
		let brideSideCheckBox2 = document.getElementById('brideSideCheckBox2');

		//예식장
		let date = document.getElementsByClassName('datepicker')[0];
		let time = document.getElementById('currentTime');
		let weddingHallName = document.getElementsByName('weddingHallName')[0];
		let weddingHallDetail = document.getElementsByName('weddingHallDetail')[0];
		let weddingHallCall = document.getElementsByName('weddingHallCall')[0];
		let weddingHallAddress = document
				.getElementsByName('weddingHallAddress')[0];
		...
		let accountCheckedId = accountUseable.checked ? accountUseable.id
				: null;
		...
		let formData = new FormData();
		formData.append('itemList[0].itemCode', document
				.getElementsByName('itemCode')[0].value);
		//방명록
		formData.append('itemList[0].subOptionList[' + count
				+ '].mainOptionCode', 'OP010');
		formData.append('itemList[0].subOptionList[' + count
				+ '].mainOptionName', '방명록 기능');
		formData.append('itemList[0].subOptionList[' + count
				+ '].subOptionType', 'guestbookUseable');
		formData.append('itemList[0].subOptionList[' + count
				+ '].subOptionValue', guestbookCheckedId);
		count++;

		//신랑신부
		const subOptionData = [ {
			name : groomName.name,
			value : groomName.value
		}, {
			name : groomCheckInput.name,
			value : groomCheckInput.value
		}, {
			name : groomPhoneNumber.name,
			value : groomPhoneNumber.value
		}, {
			name : groomCheckBox.name,
			value : groomCheckBox.checked
		}, {
			name : brideName.name,
			value : brideName.value
		}, {
			name : brideCheckInput.name,
			value : brideCheckInput.value
		}, {
			name : bridePhoneNumber.name,
			value : bridePhoneNumber.value
		}, {
			name : brideCheckBox.name,
			value : brideCheckBox.checked
		} ];
		for (let i = 0; i < subOptionData.length; i++) {
			formData.append('itemList[0].subOptionList[' + count
					+ '].mainOptionCode', 'OP001');
			formData.append('itemList[0].subOptionList[' + count
					+ '].mainOptionName', '신랑신부 정보');
			formData.append('itemList[0].subOptionList[' + count
					+ '].subOptionType', subOptionData[i].name);
			formData.append('itemList[0].subOptionList[' + count
					+ '].subOptionValue', subOptionData[i].value
					|| subOptionData[i].checked || false);
			count++;
		}

		//혼주
		if (honjuCheckedId === 'honjuUseable1') {
			let mainOptionCode = 'OP002';
			let mainOptionName = '혼주 정보';

			const optionData = [ {
				type : 'groomSideType1',
				value : groomSideType1.value
			}, {
				type : 'groomSideName1',
				value : groomSideName1.value
			}, {
				type : 'groomSideCheckInput1',
				value : groomSideCheckInput1.value
			}, {
				type : 'groomSidePhoneNumber1',
				value : groomSidePhoneNumber1.value
			}, {
				type : 'groomSideType2',
				value : groomSideType2.value
			}, {
				type : 'groomSideName2',
				value : groomSideName2.value
			}, {
				type : 'groomSideCheckInput2',
				value : groomSideCheckInput2.value
			}, {
				type : 'groomSidePhoneNumber2',
				value : groomSidePhoneNumber2.value
			}, {
				type : 'brideSideType1',
				value : brideSideType1.value
			}, {
				type : 'brideSideName1',
				value : brideSideName1.value
			}, {
				type : 'brideSideCheckInput1',
				value : brideSideCheckInput1.value
			}, {
				type : 'brideSidePhoneNumber1',
				value : brideSidePhoneNumber1.value
			}, {
				type : 'brideSideType2',
				value : brideSideType2.value
			}, {
				type : 'brideSideName2',
				value : brideSideName2.value
			}, {
				type : 'brideSideCheckInput2',
				value : brideSideCheckInput2.value
			}, {
				type : 'brideSidePhoneNumber2',
				value : brideSidePhoneNumber2.value
			} ];
			for (let i = 0; i < optionData.length; i++) {
				if (optionData[i].value) {
					formData.append('itemList[0].subOptionList[' + count
							+ '].mainOptionCode', mainOptionCode);
					formData.append('itemList[0].subOptionList[' + count
							+ '].mainOptionName', mainOptionName);
					formData.append('itemList[0].subOptionList[' + count
							+ '].subOptionType', optionData[i].type);
					formData.append('itemList[0].subOptionList[' + count
							+ '].subOptionValue', optionData[i].value);
					count++;
				}
			}
		}
		...
		const optionData = [ {
			...
			type : 'weddingHallName',
			value : weddingHallName.value
		}, {
			type : 'weddingHallDetail',
			value : weddingHallDetail.value
		}, {
			type : 'weddingHallCall',
			value : weddingHallCall.value
		}, {
			type : 'weddingHallAddress',
			value : weddingHallAddress.value
		} ];
		for (let i = 0; i < optionData.length; i++) {
		...
		if (etcCheckedId === 'etcUseable1') {
			...
			const optionData = [ {
				...
				type : '자가용 안내',
				value : ownCarInfo.value
			}, {
				type : addOption3.value,
				value : option3.value
			}, {
				type : addOption4.value,
				value : option4.value
			}, {
				type : addOption5.value,
				value : option5.value
			}, {
				type : addOption6.value,
				value : option6.value
			} ];
			for (let i = 0; i < optionData.length; i++) {
				if (optionData[i].value) {
		...
		if (kakaoPayQR.src) {
			formData.append('itemList[0].subOptionList[' + count
					+ '].mainOptionCode', 'OP005');
			formData.append('itemList[0].subOptionList[' + count
					+ '].mainOptionName', '축의금(카카오페이)');
			formData.append('itemList[0].subOptionList[' + count
					+ '].subOptionType', 'kakaoPayQR');
			formData.append('itemList[0].subOptionList[' + count
					+ '].subOptionValue', kakaoPayQR.src);
			count++;
		}
		...
		if (accountCheckedId === 'accountUseable1') {
			...
			const optionData = [ {
				type : actSelect1.name,
				value : actSelect1.value
			}, {
				type : bank1.name,
				value : bank1.value
			}, {
				type : actNumber1.name,
				value : actNumber1.value
			}, {
				type : actName1.name,
				value : actName1.value
			},

			{
				type : actSelect2.name,
				value : actSelect2.value
			}, {
				type : bank2.name,
				value : bank2.value
			}, {
				type : actNumber2.name,
				value : actNumber2.value
			}, {
				type : actName2.name,
				value : actName2.value
			},

			{
				type : actSelect3.name,
				value : actSelect3.value
			}, {
				type : bank3.name,
				value : bank3.value
			}, {
				type : actNumber3.name,
				value : actNumber3.value
			}, {
				type : actName3.name,
				value : actName3.value
			},

			{
				type : actSelect4.name,
				value : actSelect4.value
			}, {
				type : bank4.name,
				value : bank4.value
			}, {
				type : actNumber4.name,
				value : actNumber4.value
			}, {
				type : actName4.name,
				value : actName4.value
			},

			{
				type : actSelect5.name,
				value : actSelect5.value
			}, {
				type : bank5.name,
				value : bank5.value
			}, {
				type : actNumber5.name,
				value : actNumber5.value
			}, {
				type : actName5.name,
				value : actName5.value
			},

			{
				type : actSelect6.name,
				value : actSelect6.value
			}, {
				type : bank6.name,
				value : bank6.value
			}, {
				type : actNumber6.name,
				value : actNumber6.value
			}, {
				type : actName6.name,
				value : actName6.value
			} ];

			for (let i = 0; i < optionData.length; i++) {
				if (optionData[i].value
						&& (optionData[i].value.slice(-2) != "선택")) {
					formData.append('itemList[0].subOptionList[' + count
							+ '].mainOptionCode', mainOptionCode);
					formData.append('itemList[0].subOptionList[' + count
							+ '].mainOptionName', mainOptionName);
		...
		console.log("optionSubData::"
				+ document.getElementsByName('itemCode')[0].value);
		console.log("optionSubData::" + count);
		console.log(Array.from(formData.entries()));
		serverCallByFetchAjax(formData, "/Api/InsertSubOptionStep1", "post",
				"resOptionSubData");
	}
	function resOptionSubData(serverData) {
		console.log('resOptionSubData');
		console.log(serverData);
		document.getElementsByClassName('row')[17].children[1].children[0].innerText = serverData.itemCode;
		document.getElementsByClassName('row')[17].children[1].children[1].innerText = serverData.builtDate;
		document.getElementsByClassName('row')[17].children[1].children[2].innerText = serverData.templateCode
				+ " / " + serverData.templateName;
	}
	...
	function videoOptionSubUpdate() {
		...
		if (videoURL.value) {
			...
			formData.append('itemList[0].itemCode', document
					.getElementsByName('itemCode')[0].value);
			formData.append('itemList[0].subOptionList[0].mainOptionCode',
					'OP007');
			formData.append('itemList[0].subOptionList[0].mainOptionName',
					'초대영상');
			formData.append('itemList[0].subOptionList[0].subOptionType',
					'URL 입력');
			formData.append('itemList[0].subOptionList[0].subOptionValue',
					videoURL.value);

			console.log(Array.from(formData.entries()));
			serverCallByFetchAjax(formData, "/Api/InsertSubOptionStep1",
					"post", "resOptionSubData");
		}
	}
	...
	function galleryImageData() {
		...
		if (imgElements.length > 0) {
			...
			for (let i = 0; i < imgElements.length; i++) {
				const imgUrl = imgElements[i].src;
				formData.append('itemList[0].subOptionList[' + i
						+ '].mainOptionCode', 'OP008');
				formData.append('itemList[0].subOptionList[' + i
						+ '].mainOptionName', '이미지관리');
				formData.append('itemList[0].subOptionList[' + i
						+ '].subOptionType', 'galleryImage' + (i + 1));
				formData.append('itemList[0].subOptionList[' + i
						+ '].subOptionValue', imgUrl);
			}
			console.log(document.getElementsByName('itemCode')[0].value);
			console.log(Array.from(formData.entries()));
			serverCallByFetchAjax(formData, "/Api/InsertGalleryImage", "post",
					"resGalleryImageData");
		}
	}
	...
	function resGalleryImageData(serverData) {
		...
		//document.getElementsByClassName('row')[17].children[1].children[0].innerText = serverData.itemCode;
		//document.getElementsByClassName('row')[17].children[1].children[1].innerText = serverData.builtDate;
		//document.getElementsByClassName('row')[17].children[1].children[2].innerText = serverData.templateCode + " / " + serverData.templateName;
	}
	...
	function createFile() {
		...
		formData.append("itemCode", document
				.getElementsByClassName('col-md-10')[9].children[0].innerText);
		serverCallByFetchAjax(formData, "/Api/CreateItemFile", "post",
				"resCreateFile");
	}
	...
	iframe.addEventListener("load", function() {
		...
		button.addEventListener('click', function() {
			let iframeDOM = document.querySelector('iframe');
			let exGuestBook = iframeDOM.contentWindow.document.querySelector('#exGuestBook').hidden = true;
			createFile();
		});
	});
	...
	function resCreateFile(serverData) {
		//모달 띄워주기
		let url = "http://192.168.0.36/m/"+serverData.subOptionValue+"/"+document.getElementsByName('invitationURL')[0].value;
		document.getElementsByClassName('message-box')[0].hidden = false;
		document.getElementsByClassName('URLplaceholder')[0].value = url;
	}

	//<!-- 캘린더 옵션  -->
	const offset = 1000 * 60 * 60 * 9;
	//const koreaNow = new Date((new Date()).getTime() + offset);
	document.getElementById('currentDate').value = new Date((new Date())
			.getTime()
			+ offset).toISOString().substring(0, 10);
	document.getElementById('currentTime').value = new Date((new Date())
			.getTime()
			+ offset).toISOString().slice(11, 16);
	...
	function useable() { //step1 > radio버튼 사용여부에 따른 표시처리
		let honjuUseable2 = document.getElementById('honjuUseable2');
		if (honjuUseable2.checked == true) {
	...
	function honjuDirect(num) { //혼주 직접입력
		if (num == 1) {
			document.getElementById('groomSideType1').removeAttribute('hidden');
		} else if (num == 2) {
			document.getElementById('groomSideType2').removeAttribute('hidden');
		} else if (num == 3) {
			document.getElementById('brideSideType1').removeAttribute('hidden');
		} else if (num == 4) {
			document.getElementById('brideSideType2').removeAttribute('hidden');
		}
	}

	window.addEventListener("load",function() {
		let select1 = document.getElementsByClassName('groomSideType1')[0];
		let input1 = document.getElementById("groomSideType1");

		let select2 = document.getElementsByClassName('groomSideType2')[0];
		let input2 = document.getElementById("groomSideType2");

		let select3 = document.getElementsByClassName('brideSideType1')[0];
		let input3 = document.getElementById("brideSideType1");

		let select4 = document.getElementsByClassName('brideSideType2')[0];
		let input4 = document.getElementById("brideSideType2");
		...
		let disabledOption = [
				{
					name : document.getElementsByName('groomSideName1')[0],
					phone : document.getElementsByName('groomSidePhoneNumber1')[0],
					checkBox : document.getElementById('groomSideCheckBox1')
				},
				{
					name : document.getElementsByName('groomSideName2')[0],
					phone : document.getElementsByName('groomSidePhoneNumber2')[0],
					checkBox : document.getElementById('groomSideCheckBox2')
				},
				{
					name : document.getElementsByName('brideSideName1')[0],
					phone : document.getElementsByName('brideSidePhoneNumber1')[0],
					checkBox : document.getElementById('brideSideCheckBox1')
				},
				{
					name : document.getElementsByName('brideSideName2')[0],
					phone : document.getElementsByName('brideSidePhoneNumber2')[0],
					checkBox : document.getElementById('brideSideCheckBox2')
				}, ];
					...
					.addEventListener(
							...
							function() {
								...
								if (directOption[i].type.value !== "입력안함") {
									...
									disabledOption[i].name.value = null;
									disabledOption[i].phone.value = null;
								}
							});
		}
	});
	...
	function checkboxValueChange() { //국제전화 사용여부에 따른 표시처리
		let groomBox = document.getElementById('groomCheckBox');
		let groomInput = document.getElementsByName('groomCheckInput')[0];
		let brideBox = document.getElementById('brideCheckBox');
		let brideInput = document.getElementsByName('brideCheckInput')[0];
		let isGroomChecked = groomBox.checked;
		let isBrideChecked = brideBox.checked;

		let groomSideBox1 = document.getElementById('groomSideCheckBox1');
		let groomSideInput1 = document
				.getElementsByName('groomSideCheckInput1')[0];
		let groomSideBox2 = document.getElementById('groomSideCheckBox2');
		let groomSideInput2 = document
				.getElementsByName('groomSideCheckInput2')[0];
		let isGroomSideChecked1 = groomSideBox1.checked;
		let isGroomSideChecked2 = groomSideBox2.checked;

		let brideSideBox1 = document.getElementById('brideSideCheckBox1');
		let brideSideInput1 = document
				.getElementsByName('brideSideCheckInput1')[0];
		let brideSideBox2 = document.getElementById('brideSideCheckBox2');
		let brideSideInput2 = document
				.getElementsByName('brideSideCheckInput2')[0];
		let isBrideSideChecked1 = brideSideBox1.checked;
		let isBrideSideChecked2 = brideSideBox2.checked;
		//신랑신부
		if (isGroomChecked) {
			groomInput.readOnly = false;
			groomInput.style.backgroundColor = '';
		} else {
			groomInput.readOnly = true;
			groomInput.style.backgroundColor = 'rgba(195, 195, 210, 0.5)';
		}
		if (isBrideChecked) {
			brideInput.readOnly = false;
			brideInput.style.backgroundColor = '';
		} else {
			brideInput.readOnly = true;
			brideInput.style.backgroundColor = 'rgba(195, 195, 210, 0.5)';
		}
		//신랑측
		if (isGroomSideChecked1) {
			groomSideInput1.readOnly = false;
			groomSideInput1.style.backgroundColor = '';
		} else {
			groomSideInput1.readOnly = true;
			groomSideInput1.style.backgroundColor = 'rgba(195, 195, 210, 0.5)';
		}
		if (isGroomSideChecked2) {
			groomSideInput2.readOnly = false;
			groomSideInput2.style.backgroundColor = '';
		} else {
			groomSideInput2.readOnly = true;
			groomSideInput2.style.backgroundColor = 'rgba(195, 195, 210, 0.5)';
		}
		//신부측
		if (isBrideSideChecked1) {
			brideSideInput1.readOnly = false;
			brideSideInput1.style.backgroundColor = '';
		} else {
			brideSideInput1.readOnly = true;
			brideSideInput1.style.backgroundColor = 'rgba(195, 195, 210, 0.5)';
		}

		if (isBrideSideChecked2) {
			brideSideInput2.readOnly = false;
			brideSideInput2.style.backgroundColor = '';
		} else {
			brideSideInput2.readOnly = true;
			brideSideInput2.style.backgroundColor = 'rgba(195, 195, 210, 0.5)';
		}
	}
