...
<style>
	.main{
		background-image: url("https://bonheur-storage.s3.ap-northeast-2.amazonaws.com/resources/images/wed10002.png");
	}
	.host-name > h1{
    	color: white;
    }
...
<body onload="imagesProcessing()">
    <div class="container">
        ...
        <div class="box contact">
            <div>
                <p>신랑에게 연락하기</p>
                <a href="https://naver.com"><i class="fa-solid fa-phone"></i></a>
                <a href="https://naver.com"><i class="fa-solid fa-comment-sms"></i></a>
            </div>
            <div>
                <p>신부에게 연락하기</p>
                <a href="https://naver.com"><i class="fa-solid fa-phone"></i></a>
